...
type AllConfig struct {
	...
	Feature       *FeatureConfig                `json:"feature" mapstructure:"feature" yaml:"feature"`
}
...
// FeatureConfig feature toggles
type FeatureConfig struct {
	HireMeEnabled bool `json:"hire_me_enabled" mapstructure:"hire_me_enabled" yaml:"hire_me_enabled"`
}
...
func (c *AllConfig) SetDefault() {
	...
	if c.Feature == nil {
		c.Feature = &FeatureConfig{}
	}
	// defaults
	if !c.Feature.HireMeEnabled {
		// default true per requirement
		c.Feature.HireMeEnabled = true
	}
}
...
func (c *AllConfig) SetEnvironmentOverrides() {
	...
	// environment override for feature flag
	if v := os.Getenv("ANSWER_FEATURE_HIRE_ME_ENABLED"); v != "" {
